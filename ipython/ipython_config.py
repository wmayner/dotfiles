#### README ###################
# For use with IPython 5
# sets up VI mode for editing
# and the editor
# place in path:
# $HOME/.ipython/profile_ipython5/ipython_config.py
###############################
...
# The name of a Pygments style to use for syntax highlighting:  emacs, vim,
# algol_nu, pastie, paraiso-light, fruity, bw, trac, murphy, monokai, borland,
# lovelace, paraiso-dark, igor, friendly, algol, manni, vs, colorful, perldoc,
# tango, autumn, xcode, native, rrt, default
